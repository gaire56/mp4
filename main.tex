...
To improve decision transparency, the pipeline integrates SHAP for explanation of the final LightGBM late-fusion classifier and Grad-CAM for structural evidence from the CNN-based section model, summarized compactly to fit publication constraints.
...
The malware branch studies explainable static malware detection using EMBER2024 PE features~\cite{JMGPR2024}.
...
The malware branch is implemented as a static detection problem using an EMBER2024-derived PE representation~\cite{JMGPR2024,HP20182018}.
